...
public class ConsumerWorker implements Runnable{
    ...
    private void saveBufferToHdfsFile(Set<TopicPartition> partitions) {
        // 'partition' has private access in 'org.apache.kafka.common.TopicPartition'
        // partition value 가 private 으로 바뀌면서 value 값이 아니라 partition() 함수로 가져오게 바뀐듯.
        // https://github.com/a0x8o/kafka/blob/master/clients/src/main/java/org/apache/kafka/common/TopicPartition.java
    ...
    public void stopAndMakeup() {
        logger.info("stopAndMakeup");
        consumer.wakeup();
